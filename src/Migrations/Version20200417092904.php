 ...
 */
final class Version20200417092904 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE date_added date_added DATETIME NOT NULL');
        $this->addSql('ALTER TABLE media CHANGE alt alt VARCHAR(255) DEFAULT NULL, CHANGE date_added date_added DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE date_added date_added DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE media CHANGE alt alt VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE date_added date_added DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE trick CHANGE author_id author_id INT DEFAULT NULL, CHANGE main_image_id main_image_id INT DEFAULT NULL, CHANGE date_added date_added DATETIME DEFAULT \'NULL\', CHANGE date_modified date_modified DATETIME DEFAULT \'NULL\'');
